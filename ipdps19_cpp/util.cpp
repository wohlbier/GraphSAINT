...
void load_data(char *data, s_data2d_sp &adj_full, s_data2d_sp &adj_train,
    ...
    ifs.close();
    adj_train = s_data2d_sp(dims[1]-1, dims[0]);
    ...
    adj_full = s_data2d_sp(dims[3]-1, dims[2]);
